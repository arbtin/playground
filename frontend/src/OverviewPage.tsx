        ...
        <>
            <header className="bg-white shadow-sm">
                <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900">What's in this App</h2>
                </div>
            </header>
            <main>
                <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                    <div className="relative overflow-x-auto bg-white dark:bg-grey text-black dark:text-gray-800">
                        <ReactMarkdown>
                            {'## Getting Started\n' +
                                ...
                                '## File Structure\n\r  ' +
                                '- You\'ll find files highlighted in a few different colors depending on what theme you use in IntelliJ. For the default IntelliJ dark theme, test files and directories will be green, production will be blue or white, and ignored/generated directories will be orange. If these colors do not match what you see, try to figure out how to identify each category based on your theme. \n' +
                                ...
                                '### `docker-compose.yml` \n' +
                                '\n' +
                                '- This is where we configure external dependencies that our app needs. In this case, we just have 1 container configured - which runs an instance of PostgreSQL that our app connects to at startup. You can start and stop the container in your terminal:\n' +
                                ...
                                '- This is the configuration file for our backend. You can configure all kinds of things in this file like the port the app runs on, the connection details for the database or other services, feature flags, logging settings, authentication details. This list goes on, but an important thing about this file is that we can override the values in this file using environment variables which means we can have one value set in the file when running locally and when we deploy the app, we can have different values set in production.\n' +
                                ...
                                '- Migrations allow us to incrementally modify the database schema in a way that can be shared across multiple environments (development, staging, production)\n' +

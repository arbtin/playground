...
type EditTodo =  (id: number | null, text?: string, status?: "complete" | "active") => Promise<Todo>;
...
export const editTodo: EditTodo = async (id: number | null, text?: string, status?: "complete" | "active") => (
